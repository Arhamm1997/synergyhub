...
export const initialProjects: Project[] = [
  {
    ...
    deadline: "2024-09-30",
    team: [
      { name: "Sarah Lee", avatarUrl: getAvatarPlaceholder(1), avatarHint: 'woman portrait' },
      { name: "David Chen", avatarUrl: getAvatarPlaceholder(2), avatarHint: 'man portrait professional' },
      { name: "Alex Moran", avatarUrl: getAvatarPlaceholder(0), avatarHint: 'man portrait' },
    ],
  ...
  },
  {
    ...
    deadline: "2024-07-15",
    team: [
      { name: "Maria Rodriguez", avatarUrl: getAvatarPlaceholder(3), avatarHint: 'woman professional' },
    ],
